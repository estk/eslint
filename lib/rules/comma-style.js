...
module.exports = function(context) {
    ...
    if (!exceptions["VariableDeclaration"]) { 
        nodes["VariableDeclaration"] = function(node){ validateComma(node, "declarations"); };
    }
    if (!exceptions["ObjectExpression"]) { 
        nodes["ObjectExpression"] = function(node){ validateComma(node, "properties"); };
    }
    if (!exceptions["ArrayExpression"]) { 
        nodes["ArrayExpression"] = function(node){ validateComma(node, "elements"); };
    }
